      ...
      <div className="container mx-auto px-4 relative z-10">
        ...
        <div className="mt-16 grid grid-cols-2 md:grid-cols-4 gap-8 max-w-3xl mx-auto">
          ...
          <div className="text-center">
            ...
            <div className="text-white/80">Free for Job Seekers</div>
          </div>
          <div className="text-center">
            <div className="text-3xl font-bold text-white">AI-Powered</div>
            <div className="text-white/80">Job Matching</div>
          </div>
          <div className="text-center">
            <div className="text-3xl font-bold text-white">Trusted</div>
            <div className="text-white/80">by 10K+ Companies</div>
          </div>
        </div>
      </div>
    </section>
